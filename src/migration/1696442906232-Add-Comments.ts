...
export class AddComments1696442906232 implements MigrationInterface {
    name = 'AddComments1696442906232'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`comments\` ADD CONSTRAINT \`FK_7003671d633d8cd4a7e3f1933cb\` FOREIGN KEY (\`replyToId\`) REFERENCES \`comments\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
